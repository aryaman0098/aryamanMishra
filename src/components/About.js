    ...
    return (
        <div className="about_page">
            <div className = "main_body_about">
                ...
                <br />
                <p className = "about_">Hi! I am Aryaman Mishra. I live in Chandigarh. Going a little back, I was born in a small town called Rewa, Madhya Pradesh. Immediately after that, my parents went to live in Shillong, Meghalaya, a beautiful city amongst hills. I undertook my primary education in this city. Staying there, I got the oppurtunity to visit many towns and villages in the seven sister states in the North East. After staying in Shillong for 11 years, I moved to DehraDun, Uttarakhand, an amazing valley surrounded by Himalayan mountains. I made a lot of friends during the years I spent in DehradDun, enjoyed my school life and travelled the nooks and corner of this exquisite state. 
